    ...
    const filterProducts = () => {
      const categoriesFilter = Array.from(
        document.querySelectorAll(
          'input[type="checkbox"][value^="computadora"]:checked, input[type="checkbox"][value^="celular"]:checked, input[type="checkbox"][value^="tablet"]:checked, input[type="checkbox"][value^="almacenamiento"]:checked'
        )
